...
$(eval $(call target,JPEGTRAN,LIBMOZJPEG))
$(eval $(call target,LIBMOZJPEG,,libjpeg$(DLEXT)))
...
## jpegoptim
$(eval $(call depend,JPEGOPTIM,LIBMOZJPEG))
...
$(JPEGTRAN_TARGET) :; # built in $(LIBMOZJPEG_TARGET)
